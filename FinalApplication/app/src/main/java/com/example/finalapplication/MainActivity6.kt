...
class MainActivity6 : AppCompatActivity() {
    ...
    lateinit var bash_exec : Button
    lateinit var bash_output : TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bash_exec = findViewById(R.id.button6)
        bash_output = findViewById(R.id.textView6)
    ...
    override fun onStart() {
        ...
        //if(isBound_socket){
        bash_exec.setOnClickListener(){
            Log.d("Button6","Button6 is pressed.")
            var filename = bash_input.text.toString()
            bash_output.setText(socketservice?.commandExec("bash "+filename))
        }
        //}
    }
}
